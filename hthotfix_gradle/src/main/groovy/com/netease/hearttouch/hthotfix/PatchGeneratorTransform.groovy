 ...
 * 将有变化的class文件写到指定目录
 */
public class PatchGeneratorTransform extends Transform {

    private final String NAME ="PatchGenerator"
    private final Project project
    private  HTHotfixExtension hotfixExtension
    private  PatchGeneratorTransformExecutor executor;
    private final RefScanInstrument refScanInstrumentContext;
    public PatchGeneratorTransform(Project project,HTHotfixExtension extension,RefScanInstrument refScanInstrumentContext) {
    ...
    public void transform(
        ...
        project.getLogger().error("patchgenerator transform")

        executor = new PatchGeneratorTransformExecutor(project,hotfixExtension,refScanInstrumentContext)
